...
import 'package:raven_temp/components/attributes/attr.dart';

String renderElement(String beginningFunc, Element? ravenHtml, Iterable<String> attrmap, {String elementName = '_element'}) {
  int closebracket = 0;
  ...
  // Add children
  beginningFunc = attachChildren(ravenHtml, beginningFunc,  elementName: elementName);
  
  beginningFunc += ('}\n' * closebracket);
  return beginningFunc;
}

String attachChildren(Element? ravenHtml, String beginningFunc, {String Function(String, Element?, Iterable<String>, {String elementName}) childFun = renderElement, String elementName = '_element'}) {
