...
Element html(String html, {String parent = 'div', Map<String, String> attributes = const {}}) {
...
Element markdown(String markdown, {String parent = 'div', Map<String, String> attributes = const {}}) {
