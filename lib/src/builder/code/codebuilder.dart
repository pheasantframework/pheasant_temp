...
String renderFunc(
  ...
  item.directives.addAll(PheasantScript(
  ...
  if (js) {
    item.body.addAll(PheasantScript(funDef: extractFunction(script)).jsMethods);
  }
  ...
  item.body.add(Class((c) => c
    ...
    ..methods.addAll(PheasantScript(
                varDef: extractVariable(script),
                funDef: extractFunction(script))
            .nonjsMethods // Add Non-JavaScript Methods
        )
    // Add fields generated from `script` file
    ..fields.addAll(PheasantScript(
            varDef: extractVariable(script), funDef: extractFunction(script))
        .fields)
